...
glm_hbo.copy().pick(picks=range(10)).plot_topo(conditions=["Sp", "Rot-TS", "Rot-Blesser","NV","NV-Rot"], axes=axes[1], colorbar=False, vlim=(-16, 16))
glm_hbo.copy().pick(picks=range(10, 20)).plot_topo(conditions=["Sp", "Rot-TS", "Rot-Blesser","NV","NV-Rot"], axes=axes[1], colorbar=False, vlim=(-16, 16))
