...
%% This version has been modified by Daniel Friedrichs (UCL)
% November 2017
...
disp('Contact: rebecca.dewey@nottingham.ac.uk')
...
% _onsets.mat file needs to be in correct folder!
load('onsets.mat')
